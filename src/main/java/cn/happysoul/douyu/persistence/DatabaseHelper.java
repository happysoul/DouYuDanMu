package cn.happysoul.douyu.persistence;
...
import cn.happysoul.douyu.dao.DanmuDAO;
...
public class DatabaseHelper {
	...
	public Map<String, Long> selectByTimeInterval(Date start, Date end, long interval) {
		...
		Collection<Map<String, Object>> results = danmuDAOMapper.selectByTimeInterval(new Timestamp(start.getTime()),
				new Timestamp(end.getTime()), interval);
	...
	public Collection<Danmu> selectAllByTime(Date start, Date end) {
		...
		Collection<DanmuDAO> daos = danmuDAOMapper.selectAllByTime(new Timestamp(start.getTime()),
